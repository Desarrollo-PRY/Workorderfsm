...
public class AdditionalAttribute {
	...
	@XmlElement(name = "friendlyValue", required = true)
	protected List<String> friendlyValue;
     ...
     * 
     */
    public List<String> getFriendlyValue() {
        if (friendlyValue == null) {
        	friendlyValue = new ArrayList<String>();
        }
